---
title: "MetFusionAnnotator Processed Report"
author: "MetFusionAnnotator"
date: "`r Sys.Date()`"
output: 
  word_document:
    toc: true
...
The MetFusionAnnotator application provides an efficient pipeline for metabolomics data processing. This report summarizes the processing steps, results, and performance metrics of your analysis.
...
- **AI Processing Performance**: 
  * **Total AI identification time: `r params$step2_time`**
...
- **Purpose**: Initial identification and matching of input compounds
...
- **Purpose**: Secondary identification for unmatched compounds
- **Method**: Advanced AI models for compound name analysis
- **Output Files**:
  * `AI_identified_cleaned_latest.csv`: Latest AI identification results
  * `AI_identify_compound_name_*_log.txt`: Detailed identification logs
...
- **Output Files**: 
  * `1.MetFusionAnnotator_Results_KEGG.csv` 
  * `2.MetFusionAnnotator_Results_Gene.csv`
  * `3.MetFusionAnnotator_Results_GO.csv`
  * `4.MetFusionAnnotator_Results_Phenotype.csv`
  * `5.MetFusionAnnotator_Results_Reactome.csv`
...
results_files_df <- data.frame(
  Filename = c(
    "0.MetFusionAnnotator_Results.csv",
    "1.MetFusionAnnotator_Results_KEGG.csv",
    "2.MetFusionAnnotator_Results_Gene.csv",
    "3.MetFusionAnnotator_Results_GO.csv", 
    "4.MetFusionAnnotator_Results_Phenotype.csv",
...
#### Main Results (0.MetFusionAnnotator_Results.csv)
...
#### KEGG Pathway Results (1.MetFusionAnnotator_Results_KEGG.csv)
...
#### Gene Interaction Results (2.MetFusionAnnotator_Results_Gene.csv)
...
#### Gene Ontology Results (3.MetFusionAnnotator_Results_GO.csv)
...
#### Phenotype Association Results (4.MetFusionAnnotator_Results_Phenotype.csv)
...
#### Reactome Pathway Results (5.MetFusionAnnotator_Results_Reactome.csv)
...
2. **Enhanced Accuracy**
   ...
   - AI-assisted identification for ambiguous cases
...
Thank you for using MetFusionAnnotator. We hope our solution brings efficiency and convenience to your research work!
